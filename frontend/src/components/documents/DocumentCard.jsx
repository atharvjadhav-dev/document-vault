...
const DocumentCard = ({ document, onDownload, onDelete, onEdit, onView, onPreview }) => {
  const [menuOpen, setMenuOpen] = useState(false);

  return (
    <div
      className="card-hover p-4 group relative cursor-pointer"
            ...
            <>
              ...
              <div className="absolute right-0 top-8 z-20 w-44 card shadow-lg py-1 animate-fade-in">
                <button
                  ...
                  className="w-full flex items-center gap-2 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-surface-50 dark:hover:bg-surface-dark-100 font-medium"
                >
                  <svg className="w-4 h-4 text-vault-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
